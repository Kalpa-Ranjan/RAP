CLASS zcl_rap100_gen_data_krb DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_krb IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE 'krb',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atravkrb.
    DELETE FROM zrap100_atravkrb.

    "insert travel demo data
    INSERT zrap100_atravkrb  FROM (
        SELECT
